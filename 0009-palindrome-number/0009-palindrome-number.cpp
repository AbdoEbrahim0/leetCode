#include<string>
using namespace std;
//best approach check half reversal
class Solution {
public:
...
//          int copyOfX = x;
//          int how_many_digits = log10(x) +1;     
//          int hundereds = pow(10, --how_many_digits);
//          unsigned  long long reversedNum=0;
//          while (hundereds !=0)
//          {
//              reversedNum = reversedNum + (x % 10)* hundereds;
//              hundereds /= 10;
//              x = x / 10;
//          }
//          if (reversedNum==copyOfX )
...
//      }
//  };
//methode 2 using first_digit and last digit 
//  class Solution {
//  public:
//      bool isPalindrome(int x) {
//          if (x < 0) return false;
